...
stopFrisk %>%
  ...
  ggplot(aes(x = simpleRace, fill = simpleRace, y = prop)) +
    geom_bar(stat = "identity") + 
    labs(title = "Figure 7: Proportion of those Stopped by Police who are Arrested in 2018")
```
...
stopFrisk %>%
  ...
  ggplot(aes(x = SUSPECT_SEX, fill = SUSPECT_ARRESTED_FLAG)) +
    geom_bar() +
    labs(title = "Figure : Number of Men and Women stopped or arrested in 2018")
